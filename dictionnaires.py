...
desc_roles_fr = {
    ...
    'Cupidon': "(AUTRE) Au début de la partie, le cupidon va envoyer un message au MDJ pour unir deux personnes en couple. Ces personnes pourront gagner en couple avec le cupidon ou sans lui s'il advient à mourir. Ils peuvent décider de gagner avec leur camp s'ils sont tous deux du même. Si le couple meurt, il appartient au camp du village.",
